#!/usr/bin/env python3
"""
Export one session to static JSON under web/public/data/replays/<slug>/ so the
...
# Must match web/public/app.js CHUNK_SIZE
CHUNK_SIZE = 600
...
def main() -> int:
    ...
    out_dir = ROOT / "web" / "public" / "data" / "replays" / slug
